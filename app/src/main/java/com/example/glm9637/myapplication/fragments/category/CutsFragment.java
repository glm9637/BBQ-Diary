...
public class CutsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.getCutList().observe(this, new Observer<List<CutEntry>>() {
            @Override
            public void onChanged(@Nullable List<CutEntry> cutEntries) {
    ...
    public static CutsFragment createFragment(long cutId) {
